...
if (isset($_POST['name']) && isset($_POST['season']) && isset($_POST['price'])) {

    $query1 = "INSERT INTO Products (Назва_товару, Сезон, Ціна) VALUES ('{$_POST['name']}', '{$_POST['season']}', '{$_POST['price']}')";
